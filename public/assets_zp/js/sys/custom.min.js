function init_sidebar() {
    var a = function () { 
        ...
        $RIGHT_COL.css("min-height", $(window).height()); var a = $BODY.outerHeight(), b = $BODY.hasClass("footer_fixed") ? -10 : $FOOTER.height(), c = $LEFT_COL.eq(1).height() + $SIDEBAR_FOOTER.height(), d = a < c ? c : a; d -= $NAV_MENU.height() + b, $RIGHT_COL.css("min-height", d) 
       

    }; 
    $SIDEBAR_MENU.find("a").on("click", function (b) { 
        var c = $(this).parent(); c.is(".active") ? (c.removeClass("active active-sm"), $("ul:first", c).slideUp(function () { a() })) : (c.parent().is(".child_menu") ? $BODY.is(".nav-sm") && ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul")) : ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul").slideUp()), c.addClass("active"), $("ul:first", c).slideDown(function () { a() })) }
        ), 
    $MENU_TOGGLE.on("click", function () {
        ...
        $(".col-md-3.left_col.menu_fixed, .sidebar-footer").toggleClass("expanded");
        $(".nav-md .container.body .right_col").toggleClass("disabled");
        ...
        // $BODY.hasClass("nav-md-mobile")?($SIDEBAR_MENU.find("li.active ul").hide(),
        // $SIDEBAR_MENU.find("li.active").addClass("active-md-mobile").removeClass("active")):($SIDEBAR_MENU.find("li.active-md-mobile ul").show(), 
        // $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-md-mobile")), 
        // $BODY.toggleClass("nav-md nav-md-mobile"), a()
    }),
