          ...
          {!! HTML::initForm(["name"=>"formData","tabs"=>["geral"=>["name"=>"Geral"],]]); !!}
            {!! HTML::initTab("geral",true); !!}
              ...
              {!! HTML::input(['label'=>'Legenda Link','name'=>'legenda_link','hidden'=>true]); !!}
							...
							{!!HTML::file(['label'=>'Arquivo','name'=>'arquivo','size'=>3000,'accept'=>['pdf','doc','docx','xls','xlsx','zip','rar','txt']])!!}
              {!! HTML::input(['label'=>'Legenda Arquivo','name'=>'legenda_arquivo']); !!}
